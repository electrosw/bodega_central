...
class Bodega extends CI_Controller{
    ...
    function certificarArticulo(){
        $id_articulo = $_POST['id_articulo'];
        $archivo     = $_POST['archivo'];
        $respuesta   = $this->Bodega_Model->certificarArticulo($id_articulo, $archivo);
    ...
    function validarDocAsociado(){
        $doc        = $_POST['doc'];
        $tipo       = $_POST['tipo'];
        $respuesta  = $this->Cobol_Model->validarDocAsociado($doc, $tipo);
        echo json_encode($respuesta);
    }
    ...
    function listarOrdenTraspaso(){
        ...
        foreach($respuesta->codigos as $codigo){
            ...
            $codigo->estantes_seleccionados = [(Object)array('cantidad'=>0, 'id_articulo_ingreso'=>'')];
